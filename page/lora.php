...
$suhu_result = mysqli_query($konek, "SELECT value FROM data_lora WHERE name='suhu' ORDER BY Time DESC LIMIT 1");
$kelembapan_result = mysqli_query($konek, "SELECT value FROM data_lora WHERE name='kelembapan' ORDER BY Time DESC LIMIT 1");
...
$resultpotgraf = mysqli_query($konek, "SELECT time, value FROM data_lora WHERE name='suhu'");
$resultpot1graf = mysqli_query($konek, "SELECT time, value FROM data_lora WHERE name='kelembapan'");
$waktu0 = "'0',";
$data0 = "0";
$waktu1 = "'0',";
$data1 = "0";
